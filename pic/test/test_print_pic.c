...
int test_print_pic_unit_tests(void) {
     ...
     * tblwt*-; tblwt+*; end */
    {
        ...
        /* Check typical options */
        {
            ...
            if (test_printstream("Typical Options", PIC_SUBARCH_PIC18, &d[0], &a[0], sizeof(d), flags) == 0)
                passedTests++;
            numTests++;
        }
        ...
        /* Check data type bin */
        {
            ...
            if (test_printstream("Data Type Bin", PIC_SUBARCH_PIC18, &d[0], &a[0], sizeof(d), flags) == 0)
                passedTests++;
            numTests++;
        }
        ...
        /* Check data type dec */
        {
            ...
            if (test_printstream("Data Type Dec", PIC_SUBARCH_PIC18, &d[0], &a[0], sizeof(d), flags) == 0)
                passedTests++;
            numTests++;
        }
        ...
        /* Check no original opcode */
        {
            ...
            if (test_printstream("No Original Opcode", PIC_SUBARCH_PIC18, &d[0], &a[0], sizeof(d), flags) == 0)
                passedTests++;
            numTests++;
        }
        ...
        /* Check no addresses, no destination comments */
        {
            ...
            if (test_printstream("No Addresses, No Destination Comments", PIC_SUBARCH_PIC18, &d[0], &a[0], sizeof(d), flags) == 0)
                passedTests++;
            numTests++;
        }
        ...
        /* Check assembly output */
        {
            ...
            if (test_printstream("Assembly", PIC_SUBARCH_PIC18, &d[0], &a[0], sizeof(d), flags) == 0)
                passedTests++;
            numTests++;
        }
    }
