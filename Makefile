...
FILE_OBJECTS = $(LIBGIS_OBJECTS) file/atmel_generic.o file/ihex.o file/srecord.o file/binary.o file/debug.o file/asciihex.o file/elf.o file/test/test_bytestream.o
