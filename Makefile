...
AVR_OBJECTS = avr/avr_instruction_set.o avr/avr_disasm.o avr/avr_instruction.o avr/test/test_disasm_avr.o avr/test/test_print_avr.o
PIC_OBJECTS = pic/pic_instruction_set.o pic/pic_disasm.o pic/pic_instruction.o pic/test/test_disasm_pic.o pic/test/test_print_pic.o
