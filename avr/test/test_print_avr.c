...
int test_print_avr_unit_tests(void) {
    ...
    /* Check typical options */
    {
        ...
        if (test_printstream("Typical Options", &d[0], &a[0], sizeof(d), flags) == 0)
            passedTests++;
        numTests++;
    }
    ...
    /* Check data type bin */
    {
        ...
        if (test_printstream("Data Type Bin", &d[0], &a[0], sizeof(d), flags) == 0)
            passedTests++;
        numTests++;
    }
    ...
    /* Check data type dec */
    {
        ...
        if (test_printstream("Data Type Dec", &d[0], &a[0], sizeof(d), flags) == 0)
            passedTests++;
        numTests++;
    }
    ...
    /* Check no original opcode */
    {
        ...
        if (test_printstream("No Original Opcode", &d[0], &a[0], sizeof(d), flags) == 0)
            passedTests++;
        numTests++;
    }
    ...
    /* Check no addresses, no destination comments */
    {
        ...
        if (test_printstream("No Addresses, No Destination Comments", &d[0], &a[0], sizeof(d), flags) == 0)
            passedTests++;
        numTests++;
    }
    ...
    /* Check assembly output */
    {
        ...
        if (test_printstream("Assembly", &d[0], &a[0], sizeof(d), flags) == 0)
            passedTests++;
        numTests++;
    }
